  ...
  render(h) {
    ...
    return (
      <table
        ...
        border="0">
        <colgroup>
          {/* 整个是列样式的定义地方，<col>该标签专门定义整个列的样式 */}
          {
            /**
             * https://github.com/vuejs/vue/blob/52719ccab8fccffbdf497b96d3731dc86f04c1ce/src/core/instance/render-helpers/index.js  // _l方法的连接
             */
