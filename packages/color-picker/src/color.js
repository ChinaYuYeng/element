...
export default class Color {
  constructor(options) {
    ...
    this.enableAlpha = false; //是否使用透明度
    this.format = 'hex'; //转换成什么格式的代码
    this.value = ''; //这个对象的颜色代码
  ...
  fromString(value) {
    ...
    const fromHSV = (h, s, v) => {
      this._hue = Math.max(0, Math.min(360, h)); //h大于0小于360，不需要if语句
